...
# Bot pics
PICS = (environ.get('PICS', 'https://graph.org/file/61a21ee9ec2e587343c2e.jpg')).split()
...
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1001842804796').split()]
if len(AUTH_CHANNEL) == 0:
    print('Info - AUTH_CHANNEL is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1001713712725')
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/Rohesh_Bots')
OWNER_USERNAME = environ.get("OWNER_USERNAME", "https://t.me/Rohesh_Gavit")
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/Rohesh_Bots')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/Filmy_Rohesh_Files')
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002009981631")
